...
# project's own docs/CAPABILITY_MATRIX.md. `text_overlay` and `image_overlay` are both the
# free-form "overlay" capability there (`motion_graphics.overlay`, "free-form text,
# image/logo overlay"); `title` and `lower_third` each get their own built-in-template id.
