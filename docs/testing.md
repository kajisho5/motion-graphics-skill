...
└── test_integration.py    -- real ffmpeg-skill + real media: title, lower_third, text_overlay, image_overlay, bug, chapter, fade, multi-element pipelines, reuse + tamper detection, Unicode text, cancellation, CLI exit codes
```
